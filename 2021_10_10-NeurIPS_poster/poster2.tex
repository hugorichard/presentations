...
\setbeamertemplate{headline}{
  ...
  \begin{columns}[T]
    \begin{column}{.8\linewidth}
      ...
      \includegraphics[scale=0.05]{github} {\color{jblue} \large{\url{https://github.com/hugorichard/ShICA}}}
    \end{column}
    \begin{column}{.2\linewidth}
      \vskip1cm
      \includegraphics[height=12em]{neurips}
      \includegraphics[height=7em]{inria}
      \includegraphics[height=7em]{psl}
      \includegraphics[height=7em]{ups}
      \includegraphics[height=7em]{uoh}
      \includegraphics[height=7em]{cea}
      \hskip1cm
    \end{column}        
  \end{columns}
  % \vspace{0.5in}
